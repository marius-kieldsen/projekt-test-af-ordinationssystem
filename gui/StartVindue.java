...
public class StartVindue extends Application {
	...
	private void initTabPane(TabPane tabPane) {
		...
		gui.OpretOrdinationPane opretOrdinationsPane = new gui.OpretOrdinationPane();
		tabOpret.setContent(opretOrdinationsPane);
		gui.VisOrdinationPane visOrdinationPane = new gui.VisOrdinationPane();
		tabVis.setContent(visOrdinationPane);
		gui.StatistikPane statisikPane = new gui.StatistikPane();
